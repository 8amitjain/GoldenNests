...
class Cart(models.Model):
    ...
    order_ref_number = models.CharField(null=True, blank=True, max_length=15)
    product_title = models.CharField(max_length=200, null=True, blank=True)
    product_discount_price = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True)
    variation_title = models.CharField(max_length=200, null=True, blank=True)
    variation_price = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True)
...
class CouponCustomer(models.Model):
    ...
    session_user = models.CharField(null=True, blank=True, max_length=200)
...
class OfflineOrder(models.Model):
    ...
    cart = models.ManyToManyField(TableCart, blank=True)
    session_user = models.CharField(null=True, blank=True, max_length=200)
